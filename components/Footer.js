        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <a href="/privacy-policy" className="text-gray-400 hover:underline">
              Site built by Ritvik Irigireddy
            </a>
          </div>
          ...
          <div className="flex items-center">
            {/* Instagram Icon */}
            <a
              href="https://www.instagram.com/cca_deca/"
              target="_blank"
            ...
            {/* Email Icon */}
            <a
              href="mailto:ravensdeca@gmail.com"
              className="text-gray-400 mx-2"
            >
            ...
            {/* GoFundMe Icon */}
            <a
              href="https://www.gofundme.com/f/help-out-the-cca-deca-chapter"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 mx-2"
            >
